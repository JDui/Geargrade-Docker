...
def holding_duration_leaderboard(
    ...
    category: DeviceCategory | None = Query(default=None),
    db: Session = Depends(get_db),
) -> HoldingDurationResponse:
    return get_holding_duration_leaderboard(
        db,
...
def score_leaderboard(
    ...
    return get_score_leaderboard(db, sort_order=sort_order, category=category)
...
def finance_leaderboard(
    ...
    return get_finance_leaderboard(db, sort_order=sort_order, category=category)
